    ...
    def simple_scan(self):
        ...
        for count in range(1, self.y_count + 1):
            ...
            if next_direction_y == "UP":
                # UP: Stop when realtime Y position reaches -50mm or higher (near home)
                # Using 50mm threshold for safety margin
                print(f"Column {count}: vertical pass UP until Y position reaches ~-50 mm (threshold-based, collecting data)")
