...
def load_raw_data():
    ...
    # Search/filter entry with onboard keyboard support
    search_frame = tk.Frame(dialog, bg="#e5e5e5")
    search_frame.pack(fill=tk.X, padx=10, pady=5)
    
    tk.Label(search_frame, text="Filter:", font=("Arial", 10, "bold"), bg="#e5e5e5").pack(side=tk.LEFT, padx=5)
    search_var = tk.StringVar()
    search_entry = tk.Entry(search_frame, textvariable=search_var, font=("Arial", 11), relief="sunken", bd=2)
    ...
    file_listbox = tk.Listbox(list_frame, font=("Arial", 11), yscrollcommand=scrollbar.set, 
    ...
    def populate_files(directory, filter_text=""):
        ...
        try:
            ...
            if files:
                file_listbox.selection_set(0)  # Select first file by default
        except Exception as e:
