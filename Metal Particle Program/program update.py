...
class GUIClass(PortDefineClass):
    ...
    def __init__(self):
        ...
        self.scan_area_minus = Button(self.win, text = '↑z', font=("Helvetica", 20), command = self.decrease_scan_area)
        ...
        self.clock_label.place(x=5, y=5) # Positioned under the logo/buttons area
        ...
        self.timezone_combo = ttk.Combobox(self.win, textvariable=self.timezone_var, 
                                          values=self.common_timezones, state='readonly', 
                                          width=12, font=self.labelFont3)
        self.timezone_combo.place(x=190, y=5)
