...
FIXED_DISPLAY_X = 920  # Fixed X-axis display range in mm
FIXED_DISPLAY_Y = 920  # Fixed Y-axis display range in mm
...
scan_area_x = 190  # Actual scan area X in mm (from scanner)
scan_area_y = 190  # Actual scan area Y in mm (from scanner)
...
def read_loop():
    ...
    while True:
        ...
        if x0 == 0 and y0 == 0:
            ...
            print("[INFO] Display range FIXED at 920x920mm")
...
def show_loaded(xs, ys, zs):
    ...
    ax.set_title("Loaded Raw Data (2D) - 920x920mm", fontsize=12, pad=30)
