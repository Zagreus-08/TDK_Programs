...
- INVERTED COORDINATES: (0,0) starts at TOP-LEFT corner
  * X-axis: Left (max) to Right (0) - INVERTED
  * Y-axis: Top (max) to Bottom (0) - INVERTED
  * Display shows: Top-left = (300,300), Bottom-right = (0,0)
  * Scanner sends data from top-left, moving right, then down
"""
...
def update(i, xt, yt, zt, zmin_arg, zmax_arg):
    ...
    # INVERT BOTH axes: (0,0) at top-left corner
    # X: 0 becomes 100, 100 becomes 0 (flip horizontally)
    # Y: 0 becomes 100, 100 becomes 0 (flip vertically)
    xs = [100 - xi for xi in xs]
    ys = [100 - yi for yi in ys]
