...
class GUIClass(PortDefineClass):
    ...
    def __init__(self):
        ...
        self.MoveCalibButton.place(x = 640, y = 120)
    ...
    def update_grid_display(self):
        self.label_grid_info.config(text=f'{StatusDataClass.roughness}mm | {StatusDataClass.xdensity}x{StatusDataClass.ydensity}')
