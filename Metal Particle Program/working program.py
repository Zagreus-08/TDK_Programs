...
# ---------------- System Controls (Right Panel) ----------------
controls_frame = tk.Frame(main_frame, bg="#d9d9d9", padx=10, pady=10)
...
def safe_action(func):
    """Pause animation, safely run toolbar action, then resume"""
    pause_animation()
...
def do_save():
    safe_action(hidden_toolbar.save_figure)
